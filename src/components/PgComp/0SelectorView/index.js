...
import LiveSelector from '@site/src/components/PgComp/live/0LCLive';
import ViewSelector from '@site/src/components/PgComp/view/0LCView';
import CodeSelector from '@site/src/components/PgComp/code/0LCCode';
